    ...
    <Box  sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div">
        <span style={{cursor:'pointer'}} onClick={logOut}><i className="fas fa-sign-out-alt m-3"></i>Logout</span>
          </Typography>
        </Toolbar>
      </AppBar>
     ...
     <Link to={'/home'}> <button className="dashboard_icon"><i className=" mt-4 fas fa-home home"></i>Home</button> </Link>
        <Link to={`${url}/payment`}>  <button className="dashboard_icon"><i className="fab fa-amazon-pay pay"></i>Payment</button> </Link>
    {
      admin &&
